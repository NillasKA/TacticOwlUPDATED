...
namespace Tacticowl
{
	...
	public class ModSettings_Tacticowl : ModSettings
	{
		public override void ExposeData()
		{
			...
			Scribe_Values.Look(ref searchAndDestroyEnabled, "searchAndDestroyEnabled", false);
			Scribe_Values.Look(ref dualWieldEnabled, "dualWieldEnabled", false);
